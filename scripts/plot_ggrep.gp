...
plot 'results/ggrep_bench_literal_ggrep.dat' using 1:2 with linespoints ls 1 title "Our ggrep", \
     'results/ggrep_bench_literal_grrep.dat' using 1:2 with linespoints ls 2 title "bep/grrep", \
