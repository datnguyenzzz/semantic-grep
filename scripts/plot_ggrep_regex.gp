...
plot 'results/ggrep_bench_regex_ggrep.dat' using 1:2 with linespoints ls 1 title "Our ggrep (DFA-Rx)", \
     'results/ggrep_bench_regex_ggrep_std.dat' using 1:2 with linespoints ls 2 title "ggrep-std (stdlib-Rx)", \
